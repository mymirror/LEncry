...
Pod::Spec.new do |s|
  ...
  #
    ...
    s.source_files  = "LEncry/LEncry/LEncry.h","LEncry/LEncry/LEncry.m", "LEncry/LEncry/DDRSAWrapper/*.{h,m}","LEncry/LEncry/OpenSSL/opensslIncludes/openssl/rsa.h"
  ...
  #  you can include multiple dependencies to ensure it works.
    ...
    s.xcconfig = { "HEADER_SEARCH_PATHS" => "$(SRCROOT)/LEncry/LEncry/OpenSSL/opensslIncludes/openssl/rsa.h","LIBRARY_SEARCH_PATHS" => "$(PROJECT_DIR)/LEncry/LEncry/OpenSSL/lib" }
